...
<div class="bg-white rounded-3 d-flex flex-column justify-content-between align-items-center mt-8 py-8 justify-content-center">
    ...
    <div class="my-4 text-center">
        ...
        <span class="text-muted text-sm"> Tergabung sejak {{ Helper::convertDateFullIndo(date('d/m/Y', strtotime(auth()->user()->created_at))) }} </span>
    </div>
...
<div class="bg-white my-8 rounded-3 p-4 d-flex flex-column gap-2 menu-profile">
    <div class="py-3 d-flex gap-3 align-items-center">
        <i class="bi bi-person-fill fs-5 color-primary-logo"></i>
        <span> Akun </span>
    </div>
    <div class="py-3 d-flex gap-3 align-items-center" onclick="window.location.href='{{ route('guest.logout') }}'">
